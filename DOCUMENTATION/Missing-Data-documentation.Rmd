...
The argument `names_to = "item"` indicates that the _names_ of the name-value pairs created by `pivot_longer()` will be stored in a column named `item`. The argument `values_to = "response"` indicates that the _values_ of the name-value pairs created by `pivot_longer()` will be stored in a column named `response`.
