...
# Next {TOKEN} holds a series of numerical ranges in the format `x:y`, where `x`
# is the first item of a scale/subtest, and `y` is thte last item of that same
# scale/subtest. This assumes that items are numbered i001, i002, i003, etc.
# Thus, the first range in this list holds the item numbers for scale/subtest 1,
# the second range holds the item numbers for scale/subtest 2, and so on.
scale_assign <- list({TOKEN})
# Next {TOKEN} holds the number (n) of scales/subtests, in the format `1:n`
scale_num <- {TOKEN}
